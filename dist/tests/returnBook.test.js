...
describe("Return Book", function () {
    ...
    test('should allow returning a borrowed book', function () { return __awaiter(void 0, void 0, void 0, function () {
        var isReturned, availableBooks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lms_service.returnBook('978-3-16-148410-0')];
                case 1:
                    isReturned = _a.sent();
    ...
    test('should not allow returning a book that is not borrowed', function () { return __awaiter(void 0, void 0, void 0, function () {
        var isReturned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lms_service.returnBook('978-93-5019-561-935')];
                case 1:
                    isReturned = _a.sent();
    ...
    test('should return false when trying to return a book that does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var isReturned;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lms_service.returnBook('non-existent-isbn')];
                case 1:
                    isReturned = _a.sent();
                    expect(isReturned).toBe(false);
                    return [2 /*return*/];
